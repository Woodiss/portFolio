...
if (!empty($_POST)) {
    ...
    if (!empty($title) && !empty($price) && !empty($image)) {
        ...
        $editArticle = new Article($db);
        $editArticle->editArticle($id, $title, $price, $image, $idUser);
    }
}
?>
<!doctype html>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <form class="row" method="POST" enctype="multipart/form-data">
                    <div class="form-row m-auto col-6">
                        <div class="form-group">
                            <label for="title">Titre :</label>
                            <input type="text" class="form-control" id="title" placeholder="Titre du produit" name="title">
                        </div>
                        <div class="form-group">
                            <label for="price">Prix :</label>
                            <input type="number" class="form-control" id="price" placeholder="Prix du produit" name="price">
                        </div>
                        <div class="form-group">
                            <label for="image">Image :</label>
                            <input type="file" class="form-control" id="image" placeholder="Image du produit" name="image">
                        </div>
